                        ...
                        <div class="col-8">
                            <article id="post">
                                ...
                                <div class="thumbnail mt-3">
                                    <img src="./assets/Home/img1.jpg" class="thumbnail" alt=""/>
                                </div>
                            ...
                            <div class="post-footer mb-3">
                                ...
                                <div class="post-author text-center">
                                    <div class="author-avatar">
                                        <img src="./assets/Home/face/face1.jpg" class="rounded" alt=""/>
                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="prev">
                                            ...
                                            <article class="article text-center">
                                                <div class="d-flex">
                                                    <a href="#">
                                                        <img src="./assets/Home/img9.jpg" class="object-fit" alt=""/>
                                                    </a>
                                        ...
                                        <div class="next text-right">
                                            ...
                                            <article class="article text-center">
                                                <div class="d-flex">
                                                    <a href="#">
                                                        <img src="./assets/Home/img8.jpg" class="object-fit" alt=""/>
                                                    </a>
                                                    <div class="cart-body px-1">
                                                        <div class="category">
                                                            <a href="#" class="link text-primary text-secondary">Fashion</a>
                                ...
                                <div class="post-comments py-2">
                                    ...
                                    <div class="comment-details">
                                        <div class="comment-item py-2">
                                            <div class="d-flex">
                                                <div class="avatar px-2">
                                                    <img src="./assets/face/Home/face1.jpg" class="rounded" alt=""/>
                                                </div>
                                            ...
                                            <div class="reply py-2">
                                                <div class="d-flex">
                                                    <div class="avatar px-2">
                                                        <img src="./assets/Home/face/face2.jpg" class="rounded" alt=""/>
                                                    </div>
                                                    <div class="comment-content">
                                                        <h5 class="display-2 m-0">Brandon Kelly</h5>
                                                        <p class="title-secondary text-dark">
                                        ...
                                        <div class="comment-item py-2">
                                            <div class="d-flex">
                                                <div class="avatar px-2">
                                                    <img src="./assets/Home/face/face3.jpg" class="rounded" alt=""/>
                                                </div>
                                                <div class="comment-content">
                                                    <h5 class="display-2 m-0">Brandon Kelly</h5>
                                                    <p class="title-secondary text-dark">
                                ...
                                <section class="trending-post mt-3">
                                    ...
                                    <div class="post-item py-1">
                                        <article class="article">
                                            <div class="d-flex">
                                                <a href="#">
                                                    <img src="./assets/Home/img1.jpg" class="rounded px-1" alt=""/>
                                                </a>
                                                <div class="cart-body">
                                       ...
                                       <div class="post-item py-1">
                                        <article class="article">
                                            <div class="d-flex">
                                                <a href="#">
                                                    <img src="./assets/Home/img2.jpg" class="rounded px-1" alt=""/>
                                                </a>
                                                <div class="cart-body">
                                                    <div class="trending-category">
                                                        <a href="#" class="link text-primary">
                                    ...
                                    <div class="post-item py-1">
                                        <article class="article">
                                            <div class="d-flex">
                                                <a href="#">
                                                    <img src="./assets/Home/img3.jpg" class="rounded px-1" alt=""/>
                                                </a>
                                                <div class="cart-body">
                                                    <div class="trending-category">
                                                        <a href="#" class="link text-primary">
                                       ...
                                       <div class="post-item py-1">
                                        <article class="article">
                                            <div class="d-flex">
                                                <a href="#">
                                                    <img src="./assets/Home/img4.jpg" class="rounded px-1" alt=""/>
                                                </a>
                                                <div class="cart-body">
                                                    <div class="trending-category">
                                                        <a href="#" class="link text-primary">
